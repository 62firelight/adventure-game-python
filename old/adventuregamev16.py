...
def TrainerLocation():
	...
	if player_char['first_visit_t'] == True:
		...
		# ^ just meant to be serviceable (at best), so it's pretty bad
		print("""
...
You slowly back away from Turgon. """)
				...
				break
			elif player_char['player_experience'] < trainer_required_xp:
				print("\nYou do not have enough XP to face the trainer.")
			elif player_char['player_gold'] < trainer_required_gold:
