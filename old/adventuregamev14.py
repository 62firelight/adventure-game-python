...
"But should you fail, {}, then this will all be for naught." """
...
"I wonder... could you harness such power?" """)
				confirm = input(confirm_prompt)
				print("""
...
def ShopLocation():
	...
	starter_tier_stats = [2, 2, 1, 2, 3, 4]
	mid_tier_stats = [3, 3, 3, 4, 5, 6]
	end_tier_stats = [4, 4, 4, 6, 7, 8]
...
As you take your first steps towards the village, you suddenly recall your name.
Your name is: """)
